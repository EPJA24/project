...
const Edition = ({edition}: EditionProps) => {
  return (
    <EditionContainer>
      <ImageContainer>
        {edition.imageSrc ?
          <img src={edition.imageSrc} alt="edition image" style={{borderRadius: "10px"}}/>
        : 
          <ImageFiller width={150} height={242} color='white' background='black' style={{borderRadius: "10px"}}/>
        }
      </ImageContainer>
