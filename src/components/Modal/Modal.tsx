...
import { CloseButton, ModalHeaderWrapper, ModalTitle as MT,  ModalWrapper, Content } from './Modal.styled';
import { ModalProps, ModalTriggerProps, ModalHeaderProps, ModalTitleProps, ModalContentProps } from './ModalInterfaces';
